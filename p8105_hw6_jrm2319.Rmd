...
```
Comment on the plot: New York, NY is the city with the lowest odds (-1.417) of solving a homicide when the victim is males compared to the victim being female. Albuquerque, NM (0.499) is the city with the highest odds of solving a homicide when the victim is males compared to the victim being female.In general  
